...
/** Sourced and modified from http://jabelarminecraft.blogspot.co.uk/p/minecraft-forge-1721710-creating-custom.html. */
/** Credits to Jabelar because I don't want to spend 2 hours writing a fucking entity placer class... */
public class NullifactorEntityPlacer extends ItemMonsterPlacer
{
    ...
    public NullifactorEntityPlacer()
    {
        super();
    }
