...
public enum NullifactorAchievementRegistry {
	...
	SUCKEDIN("suckedin", 6, 2, new ItemStack(ResourceItemRegistry.CDIAMONDCHOPPER.getItem()), true, NullifactorAchievementRegistry.CNULLIFACTOR.achievement),
	...
	BORDERWORLD("borderworld", -4, 2, new ItemStack(ResourceItemRegistry.CQUANTANIUMCONTMOD.getItem()), false, NullifactorAchievementRegistry.CORRUPTED.achievement),
	NULLDRIVER("nulldriver", -6, 2, new ItemStack(ResourceItemRegistry.CQUANTANIUMPWRMOD.getItem()), true, NullifactorAchievementRegistry.BORDERWORLD.achievement),
